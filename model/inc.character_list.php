...
function showCharacters($pdo) {
        ...
        echo '      <a href="character_list_controller.php?id=' . $character["character_id"] . '" class="btn btn-sm btn-link text-info p-0 text-decoration-none small">Fiche complète</a>';
        echo '  </td>';
        echo '</tr>';
    }
	}
